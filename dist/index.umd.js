(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("inversify"), require("reflect-metadata"), require("emittery"), require("dom-serializer"), require("domutils"), require("htmlparser2"), require("cookie")) : typeof define === "function" && define.amd ? define([ "exports", "inversify", "reflect-metadata", "emittery", "dom-serializer", "domutils", "htmlparser2", "cookie" ], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, 
    factory(global.BloomreachSpaSdk = {}, global.inversify, null, global.emittery, global["dom-serializer"], global.domutils, global.htmlparser2, global.cookie));
})(this, (function(exports, inversify, reflectMetadata, emittery, render, domutils, htmlparser2, cookie) {
    "use strict";
    ...
    var render__default = _interopDefaultLegacy(render);
    var cookie__default = _interopDefaultLegacy(cookie);
    /******************************************************************************
    ...
    ***************************************************************************** */    function __decorate(decorators, target, key, desc) {
    ...
    Logger = __decorate([ inversify.injectable(), __metadata("design:paramtypes", []) ], Logger);
    ...
    ConsoleLogger = __decorate([ inversify.injectable(), __param(0, inversify.inject(ConsoleToken)), __metadata("design:paramtypes", [ Object ]) ], ConsoleLogger);
    ...
    let CmsImpl = class CmsImpl {
        ...
        initialize(_ref) {
            let {window = GLOBAL_WINDOW$2} = _ref;
            var _a, _b, _c, _d;
    ...
    CmsImpl = __decorate([ inversify.injectable(), __param(0, inversify.inject(RpcClientService)), __param(1, inversify.inject(RpcServerService)), __param(2, inversify.inject(CmsEventBusService)), __param(2, inversify.optional()), __param(3, inversify.inject(Logger)), __param(3, inversify.optional()), __metadata("design:paramtypes", [ Object, Object, Object, Logger ]) ], CmsImpl);
    ...
    let Cms14Impl = class Cms14Impl {
        ...
        postpone(task) {
            ...
            return function() {
                ...
                _this.postponed.push(task.bind(_this, ...args));
                return undefined;
            };
        }
        initialize(_ref) {
            let {window = GLOBAL_WINDOW$1} = _ref;
            var _a, _b;
    ...
    Cms14Impl = __decorate([ inversify.injectable(), __param(0, inversify.inject(CmsEventBusService)), __param(0, inversify.optional()), __param(1, inversify.inject(Logger)), __param(1, inversify.optional()), __metadata("design:paramtypes", [ Object, Logger ]) ], Cms14Impl);
    ...
    let PostMessage = class PostMessage extends Rpc {
        ...
        initialize(_ref) {
            let {origin, window = GLOBAL_WINDOW} = _ref;
            var _a, _b;
    ...
    PostMessage = __decorate([ inversify.injectable(), __param(0, inversify.inject(Logger)), __param(0, inversify.optional()), __metadata("design:paramtypes", [ Logger ]) ], PostMessage);
    function CmsModule() {
        return new inversify.ContainerModule((bind => {
            bind(CmsEventBusService).toDynamicValue((() => new emittery.Typed)).inSingletonScope().when((() => typeof window !== "undefined"));
    ...
    ComponentImpl$1 = __decorate([ inversify.injectable(), __param(0, inversify.inject(ComponentModelToken)), __param(1, inversify.inject(ComponentChildrenToken)), __param(2, inversify.inject(LinkFactory)), __param(3, inversify.inject(MetaCollectionFactory)), __metadata("design:paramtypes", [ Object, Array, LinkFactory, Function ]) ], ComponentImpl$1);
    /**
    ...
    ComponentImpl = __decorate([ inversify.injectable(), __param(0, inversify.inject(ComponentModelToken)), __param(1, inversify.inject(ComponentChildrenToken)), __param(2, inversify.inject(MetaCollectionFactory)), __param(3, inversify.inject(UrlBuilderService)), __metadata("design:paramtypes", [ Object, Array, Function, Object ]) ], ComponentImpl);
    /**
     * Checks whether a value is a page component.
     * @param value The value to check.
    ...
    ContainerItemImpl$1 = __decorate([ inversify.injectable(), __param(0, inversify.inject(ComponentModelToken)), __param(1, inversify.inject(LinkFactory)), __param(2, inversify.inject(MetaCollectionFactory)), __param(3, inversify.inject(PageEventBusService)), __param(3, inversify.optional()), __param(4, inversify.inject(Logger)), __param(4, inversify.optional()), __metadata("design:paramtypes", [ Object, LinkFactory, Function, Object, Logger ]) ], ContainerItemImpl$1);
    /**
    ...
    ContainerItemImpl = __decorate([ inversify.injectable(), __param(0, inversify.inject(ComponentModelToken)), __param(1, inversify.inject(MetaCollectionFactory)), __param(2, inversify.inject(UrlBuilderService)), __param(3, inversify.inject(PageEventBusService)), __param(3, inversify.optional()), __param(4, inversify.inject(Logger)), __param(4, inversify.optional()), __metadata("design:paramtypes", [ Object, Function, Object, Object, Logger ]) ], ContainerItemImpl);
    /**
     * Checks whether a value is a page container item.
     * @param value The value to check.
    ...
    let MetaCollectionImpl = MetaCollectionImpl_1 = class MetaCollectionImpl extends Array {
        ...
        clear() {
            let comments = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [ ...this.comments ];
    ...
    ContentFactory$1 = __decorate([ inversify.injectable() ], ContentFactory$1);
    ...
    let LinkRewriterImpl = class LinkRewriterImpl {
        ...
        rewrite(content) {
            let type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "text/html";
            const document = htmlparser2.parseDocument(content, {
                xmlMode: type !== "text/html"
            });
            this.rewriteAnchors(document);
            this.rewriteImages(document);
            return render__default["default"](document, {
                selfClosingTags: true
            });
        }
        rewriteAnchors(document) {
            Array.from(domutils.getElementsByTagName("a", document)).filter((element => domutils.hasAttrib(element, "href") && domutils.hasAttrib(element, "data-type"))).forEach((element => {
                const url = this.linkFactory.create({
                    href: domutils.getAttributeValue(element, "href"),
                    type: domutils.getAttributeValue(element, "data-type")
                });
                if (url) {
        ...
        rewriteImages(document) {
            Array.from(domutils.getElementsByTagName("img", document)).filter((element => domutils.hasAttrib(element, "src"))).forEach((element => {
                const url = this.linkFactory.create({
                    href: domutils.getAttributeValue(element, "src"),
    ...
    LinkRewriterImpl = __decorate([ inversify.injectable(), __param(0, inversify.inject(LinkFactory)), __metadata("design:paramtypes", [ LinkFactory ]) ], LinkRewriterImpl);
    ...
    PageImpl$1 = __decorate([ inversify.injectable(), __param(0, inversify.inject(PageModelToken)), __param(1, inversify.inject(ButtonFactory)), __param(2, inversify.inject(ComponentFactory$1)), __param(3, inversify.inject(ContentFactory$1)), __param(4, inversify.inject(LinkFactory)), __param(5, inversify.inject(LinkRewriterService)), __param(6, inversify.inject(MetaCollectionFactory)), __param(7, inversify.inject(CmsEventBusService)), __param(7, inversify.optional()), __param(8, inversify.inject(PageEventBusService)), __param(8, inversify.optional()), __param(9, inversify.inject(Logger)), __param(9, inversify.optional()), __metadata("design:paramtypes", [ Object, ButtonFactory, ComponentFactory$1, ContentFactory$1, LinkFactory, Object, Function, Object, Object, Logger ]) ], PageImpl$1);
    /**
    ...
    let PageImpl = PageImpl_1 = class PageImpl {
        constructor(model, buttonFactory, componentFactory, contentFactory, linkFactory, linkRewriter, metaFactory, cmsEventBus, eventBus, logger) {
            ...
            this.content = new Map(Object.entries(model.content || {}).map((_ref => {
                let [alias, m] = _ref;
                return [ alias, this.contentFactory(m) ];
            })));
        }
        onPageUpdate(event) {
            Object.entries(event.page.content || {}).forEach((_ref2 => {
                let [alias, model] = _ref2;
                return this.content.set(alias, this.contentFactory(model));
            }));
        }
        ...
        getComponent() {
            return this.root.getComponent(...arguments);
        }
        getContent(reference) {
    ...
    PageImpl = PageImpl_1 = __decorate([ inversify.injectable(), __param(0, inversify.inject(PageModelToken)), __param(1, inversify.inject(ButtonFactory)), __param(2, inversify.inject(ComponentFactory)), __param(3, inversify.inject(ContentFactory)), __param(4, inversify.inject(LinkFactory)), __param(5, inversify.inject(LinkRewriterService)), __param(6, inversify.inject(MetaCollectionFactory)), __param(7, inversify.inject(CmsEventBusService)), __param(8, inversify.inject(PageEventBusService)), __param(8, inversify.optional()), __param(9, inversify.inject(Logger)), __param(9, inversify.optional()), __metadata("design:paramtypes", [ Object, ButtonFactory, ComponentFactory, Function, LinkFactory, Object, Function, Object, Object, Logger ]) ], PageImpl);
    /**
     * Checks whether a value is a page.
     * @param value The value to check.
    ...
    function PageModule$1() {
        return new inversify.ContainerModule((bind => {
            bind(PageEventBusService).toDynamicValue((() => new emittery.Typed)).inSingletonScope().when((() => typeof window !== "undefined"));
            ...
            bind(LinkFactory).toSelf().inSingletonScope().onActivation(((_ref, factory) => {
                let {container} = _ref;
                const url = container.get(UrlBuilderService);
                return factory.register(TYPE_LINK_INTERNAL, url.getSpaUrl.bind(url));
            }));
            bind(MetaCollectionFactory).toFactory((_ref2 => {
                let {container} = _ref2;
                return model => {
            ...
            bind(MenuItemFactory).toFactory((_ref3 => {
                let {container} = _ref3;
                return model => {
                    const scope = container.createChild();
            ...
            bind(ImageFactory).toFactory((_ref4 => {
                let {container} = _ref4;
                return model => {
                    const scope = container.createChild();
            ...
            bind(PaginationItemFactory).toFactory((_ref5 => {
                let {container} = _ref5;
                return model => {
                    const scope = container.createChild();
            ...
            bind(ContentFactory$1).toSelf().inSingletonScope().onActivation(((_ref6, factory) => {
                let {container} = _ref6;
                return factory.register(TYPE_DOCUMENT, (model => {
                    const scope = container.createChild();
            ...
            bind(ComponentFactory$1).toSelf().inSingletonScope().onActivation(((_ref7, factory) => {
                let {container} = _ref7;
                return factory.register(TYPE_COMPONENT$1, ((model, children) => {
                    const scope = container.createChild();
            ...
            bind(PageFactory).toFactory((_ref8 => {
                let {container} = _ref8;
                return model => {
                    const scope = container.createChild();
    ...
    function PageModule() {
        return new inversify.ContainerModule((bind => {
            bind(PageEventBusService).toDynamicValue((() => new emittery.Typed)).inSingletonScope().when((() => typeof window !== "undefined"));
            bind(LinkRewriterService).to(LinkRewriterImpl).inSingletonScope();
            bind(ButtonFactory).toSelf().inSingletonScope().onActivation(((context, factory) => factory.register(TYPE_MANAGE_CONTENT_BUTTON, createManageContentButton).register(TYPE_MANAGE_MENU_BUTTON, (_ref => {
                let {_meta} = _ref;
                return _meta !== null && _meta !== void 0 ? _meta : {};
            }))));
            bind(LinkFactory).toSelf().inSingletonScope().onActivation(((_ref2, factory) => {
                let {container} = _ref2;
                const url = container.get(UrlBuilderService);
                return factory.register(TYPE_LINK_INTERNAL, url.getSpaUrl.bind(url));
            }));
            bind(MetaCollectionFactory).toFactory((_ref3 => {
                let {container} = _ref3;
                return model => {
                    const scope = container.createChild();
                    scope.bind(MetaCollectionImpl).toSelf();
            ...
            bind(MetaFactory).toSelf().inSingletonScope().onActivation(((context, factory) => factory.register(TYPE_META_COMMENT, ((model, position) => new MetaCommentImpl(model, position)))));
            bind(ContentFactory).toFactory((_ref4 => {
                let {container} = _ref4;
                return model => {
                    const scope = container.createChild();
            ...
            bind(ComponentFactory).toSelf().inSingletonScope().onActivation(((_ref5, factory) => {
                let {container} = _ref5;
                return factory.register(TYPE_COMPONENT, ((model, children) => {
                    const scope = container.createChild();
            ...
            bind(PageFactory).toFactory((_ref6 => {
                let {container} = _ref6;
                return model => {
                    const scope = container.createChild();
    ...
    class Cookie {
       ...
       */
        static SET_COOKIE(name, value, ttl) {
            if (this.isWindowAvailable() && name && value) {
                ...
                document.cookie = cookie__default["default"].serialize(name, value, {
                    maxAge
                });
            }
        }
       ...
       */        static GET_COOKIE() {
            var _a;
            return this.isWindowAvailable() ? cookie__default["default"].parse((_a = document.cookie) !== null && _a !== void 0 ? _a : "") : {};
        }
        /**
       ...
       */        static GET_COOKIE_FROM_REQUEST(request) {
            var _a, _b;
            return cookie__default["default"].parse((_b = (_a = request.headers) === null || _a === void 0 ? void 0 : _a.cookie) !== null && _b !== void 0 ? _b : "");
        }
        /**
       ...
       */        static ERASE_COOKIE(name) {
            if (this.isWindowAvailable()) {
                document.cookie = cookie__default["default"].serialize(name, "", {
                    maxAge: 0
                });
            }
        }
    ...
    ApiImpl = ApiImpl_1 = __decorate([ inversify.injectable(), __param(0, inversify.inject(UrlBuilderService)), __param(1, inversify.inject(ApiOptionsToken)), __param(2, inversify.inject(Logger)), __param(2, inversify.optional()), __metadata("design:paramtypes", [ Object, Object, Logger ]) ], ApiImpl);
    ...
    Spa = __decorate([ inversify.injectable(), __param(0, inversify.inject(ApiService)), __param(1, inversify.inject(PageFactory)), __param(2, inversify.inject(CmsEventBusService)), __param(2, inversify.optional()), __param(3, inversify.inject(PageEventBusService)), __param(3, inversify.optional()), __param(4, inversify.inject(Logger)), __param(4, inversify.optional()), __metadata("design:paramtypes", [ Object, Function, Object, Object, Logger ]) ], Spa);
    function SpaModule() {
        return new inversify.ContainerModule((bind => {
    ...
    exports.TYPE_CONTAINER_ITEM_UNDEFINED = TYPE_CONTAINER_ITEM_UNDEFINED;
    ...
    exports.extractSearchParams = extractSearchParams;
    exports.getContainerItemContent = getContainerItemContent;
